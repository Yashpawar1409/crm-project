...
import { generateCampaignMessages } from "../controller/ai-controller";
import { generateCampaignSummary } from "../controller/ai-controller";
...
router.post("/generate-messages", generateCampaignMessages);



router.post("/generate-summary", generateCampaignSummary);
